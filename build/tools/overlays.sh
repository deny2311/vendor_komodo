...
cur_dir=`pwd`
flashable_zip_template="$ANDROID_BUILD_TOP/vendor/komodo/build/tools/overlays_zip_template"
overlays_path_top="$ANDROID_BUILD_TOP/vendor/komodo/overlay/themes/"
overlays_path_temp="$ANDROID_BUILD_TOP/overlays_temp"
overlays_zip_name="komodo_overlays.zip"
